...
export type WorkspaceDirectoryQuery = { organisations: Array<{ id: string | null, name: string | null, propelAuthOrgId: string | null }> | null, workspaces: Array<{ id: string | null, name: string | null, organisationId: string | null, isDefault: boolean | null }> | null };
