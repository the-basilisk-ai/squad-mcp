...
import {
    ...
    TokenExchangeResponseFromJSON,
    TokenExchangeResponseToJSON,
...
export class SquadApi extends runtime.BaseAPI {
    ...
    /**
     * Accepts a PropelAuth opaque access token (from an OAuth2 PKCE flow) and returns a short-lived JWT suitable for authenticating with the Squad API. Intended for CLI and other native application integrations.
     * Exchange an OAuth opaque token for a JWT
     */
    async exchangeTokenRaw(requestParameters: ExchangeTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenExchangeResponse>> {
        if (requestParameters['authorization'] == null) {
            throw new runtime.RequiredError(
                'authorization',
                'Required parameter "authorization" was null or undefined when calling exchangeToken().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => TokenExchangeResponseFromJSON(jsonValue));
    }
     ...
     * Exchange an OAuth opaque token for a JWT
     */
    async exchangeToken(requestParameters: ExchangeTokenRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TokenExchangeResponse> {
